...
public class LottoGame extends JFrame {
	...
	// public LottoGame(String correctNumbers) {
	// 	this();
	// 	lblDispCorrectNumbers.setVisible(true);
	// 	lblDispCorrectNumbers.setText(correctNumbers);
	// 	JOptionPane.showMessageDialog(null, "You have guessed : \n"+ correctNumbers);
	// }
	...
	private void drawTimer() {
		...
		if(isSubmitClicked) {
			...
			timer.schedule(new TimerTask() {
				...
				int min=Integer.parseInt(arr[1])*60; //01 minute
				public void run(){
					// int a=Integer.parseInt(txtDrawTimer.getText());
					min--;
			...
			if(iscbLottoclicked) {
				if(countA == 1 || countB == 1 || countA == 2 || countB == 2 || countA == 3 || countB == 3 || countA == 4 || countB == 4 || countA == 5 || countB == 5) {
					...
					if((countA == 1 || countA == 2 || countA == 3) && (countB == 1 || countB == 2 || countB == 3)) {
						...
						//WAG KALIMUTAN PALITAN YUNG PRIZE
					}
	...
	private void btnPlayAgainMouseClicked(MouseEvent e) {
		...
		if(playAgain == JOptionPane.YES_OPTION) {
			...
			// new LottoGame("Card A: " + lblCorrectNumbersA.getText() + "\n" + "Card B: " + lblCorrectNumbersB.getText());
		}
	...
	private void setVisiblePanel3() {
		panelGameField2.setVisible(false);
		panelGameField3.setVisible(true);
		lblP2Congratulations.setVisible(true);
		lblWonCP.setVisible(true);
		lblUserPrize.setVisible(true);
		lblCorrectNumbers.setVisible(true);
		lblCorrectNumbersA.setVisible(true);
		lblCorrectNumbersB.setVisible(true);
		lblCardA.setVisible(true);
		lblCardB.setVisible(true);
		lblPanelbgGF.setVisible(true);
		lblFireworks1.setVisible(false);
		lblFireworks2.setVisible(false);
		lblFireworks3.setVisible(false);
		lblFireworks4.setVisible(false);
		lblFireworks5.setVisible(false);
		lblFireworks6.setVisible(false);
		lblFireworks7.setVisible(false);
		lblFireworks8.setVisible(false);
		lblFireworks9.setVisible(false);
		lblPartyPopper.setVisible(false);
	}

	private void putFireworks() {
		lblFireworks1.setVisible(true);
		lblFireworks2.setVisible(true);
		lblFireworks3.setVisible(true);
		lblFireworks4.setVisible(true);
		lblFireworks5.setVisible(true);
		lblFireworks6.setVisible(true);
		lblFireworks7.setVisible(true);
		lblFireworks8.setVisible(true);
		lblFireworks9.setVisible(true);
		lblPartyPopper.setVisible(true);
	}

	private void setVisibleGameFieldComponents() {
		lblFirstB.setVisible(false);
		lblDrawFirstBall.setVisible(false);
		lblDrawFirstNumber.setVisible(false);
		lblSecondB.setVisible(false);
		lblDrawSecondBall.setVisible(false);
		lblDrawSecondNumber.setVisible(false);
		lblThirdB.setVisible(false);
		lblDrawThirdBall.setVisible(false);
		lblDrawThirdNumber.setVisible(false);
		lblFourthB.setVisible(false);
		lblDrawFourthBall.setVisible(false);
		lblDrawFourthNumber.setVisible(false);
		lblFifthB.setVisible(false);
		lblDrawFifthBall.setVisible(false);
		lblDrawFifthNumber.setVisible(false);
		lblSixthB.setVisible(false);
		lblDrawSixthBall.setVisible(false);
		lblDrawSixthNumber.setVisible(false);
		lblPrize.setVisible(false);
		lblPrizepool.setVisible(false);
		lblGameField.setVisible(false);
	}

	private void setVisibleComponents() {
		lblUserChosenNumbers.setVisible(true);
		txtDrawTimer.setVisible(false);
		btnPlayAgain.setVisible(false);
		...
		lblChooseA.setVisible(false);
		lblChooseB.setVisible(false);
		lblGameField.setVisible(false);
		lblPrizepool.setVisible(false);
		txtDrawTimer.setVisible(false);
		...
		//FOR RECEIPT
		lblUserChosenNumbers.setVisible(false);
		lblReceiptGameTitle.setVisible(false);
		lblReceiptGameTitle2.setVisible(false);
		lblReceiptA.setVisible(false);
		lblReceiptAgent.setVisible(false);
		lblReceiptAgentOutput.setVisible(false);
		lblReceiptB.setVisible(false);
		lblReceiptDate.setVisible(false);
		lblReceiptDateOutput.setVisible(false);
		lblReceiptDraw.setVisible(false);
		lblReceiptDrawOutput.setVisible(false);
		lblReceiptLotto.setVisible(false);
		lblDashedLines1.setVisible(false);
		lblDashedLines2.setVisible(false);

		btnA1.setVisible(false);
		btnA2.setVisible(false);
		btnA3.setVisible(false);
		btnA4.setVisible(false);
		btnA5.setVisible(false);
		btnA6.setVisible(false);
		btnA7.setVisible(false);
		btnA8.setVisible(false);
		btnA9.setVisible(false);
		btnA10.setVisible(false);
		btnA11.setVisible(false);
		btnA12.setVisible(false);
		btnA13.setVisible(false);
		btnA14.setVisible(false);
		btnA15.setVisible(false);
		btnA16.setVisible(false);
		btnA17.setVisible(false);
		btnA18.setVisible(false);
		btnA19.setVisible(false);
		btnA20.setVisible(false);
		btnA21.setVisible(false);
		btnA22.setVisible(false);
		btnA23.setVisible(false);
		btnA24.setVisible(false);
		btnA25.setVisible(false);
		btnA26.setVisible(false);
		btnA27.setVisible(false);
		btnA28.setVisible(false);
		btnA29.setVisible(false);
		btnA30.setVisible(false);
		btnA31.setVisible(false);
		btnA32.setVisible(false);
		btnA33.setVisible(false);
		btnA34.setVisible(false);
		btnA35.setVisible(false);
		btnA36.setVisible(false);
		btnA37.setVisible(false);
		btnA38.setVisible(false);
		btnA39.setVisible(false);
		btnA40.setVisible(false);
		btnA41.setVisible(false);
		btnA42.setVisible(false);
		btnA43.setVisible(false);
		btnA44.setVisible(false);
		btnA45.setVisible(false);
		btnA46.setVisible(false);
		btnA47.setVisible(false);
		btnA48.setVisible(false);
		btnA49.setVisible(false);
		btnA50.setVisible(false);
		btnA51.setVisible(false);
		btnA52.setVisible(false);
		btnA53.setVisible(false);
		btnA54.setVisible(false);
		btnA55.setVisible(false);
		btnA56.setVisible(false);
		btnA57.setVisible(false);
		btnA58.setVisible(false);
		...
		btnB11.setVisible(false);
		btnB12.setVisible(false);
		btnB13.setVisible(false);
		btnB14.setVisible(false);
		btnB15.setVisible(false);
		btnB16.setVisible(false);
		btnB17.setVisible(false);
		btnB18.setVisible(false);
		btnB19.setVisible(false);
		btnB20.setVisible(false);
		btnB21.setVisible(false);
		btnB22.setVisible(false);
		btnB23.setVisible(false);
		btnB24.setVisible(false);
		btnB25.setVisible(false);
		btnB26.setVisible(false);
		btnB27.setVisible(false);
		btnB28.setVisible(false);
		btnB29.setVisible(false);
		btnB30.setVisible(false);
		btnB31.setVisible(false);
		btnB32.setVisible(false);
		btnB33.setVisible(false);
		btnB34.setVisible(false);
		btnB35.setVisible(false);
		btnB36.setVisible(false);
		btnB37.setVisible(false);
		btnB38.setVisible(false);
		btnB39.setVisible(false);
		btnB40.setVisible(false);
		btnB41.setVisible(false);
		btnB42.setVisible(false);
		btnB43.setVisible(false);
		btnB44.setVisible(false);
		btnB45.setVisible(false);
		btnB46.setVisible(false);
		btnB47.setVisible(false);
		btnB48.setVisible(false);
		btnB49.setVisible(false);
		btnB50.setVisible(false);
		btnB51.setVisible(false);
		btnB52.setVisible(false);
		btnB53.setVisible(false);
		btnB54.setVisible(false);
		btnB55.setVisible(false);
		btnB56.setVisible(false);
		btnB57.setVisible(false);
		btnB58.setVisible(false);
	...
	private void setForegroundText() {
		lblYourNumbersA.setForeground(Color.BLACK);
		lblYourNumbersB.setForeground(Color.BLACK);
		lblA.setForeground(Color.BLACK);
		lblB.setForeground(Color.BLACK);
		lblReceiptAgent.setForeground(Color.BLACK);
		lblReceiptAgentOutput.setForeground(Color.BLACK);
		lblReceiptDate.setForeground(Color.BLACK);
		lblReceiptDateOutput.setForeground(Color.BLACK);
		lblReceiptDraw.setForeground(Color.BLACK);
		lblReceiptDrawOutput.setForeground(Color.BLACK);
		lblDashedLines1.setForeground(Color.BLACK);
		lblDashedLines2.setForeground(Color.BLACK);
		lblReceiptA.setForeground(Color.RED);
		lblReceiptB.setForeground(Color.RED);
		lblYourNumbersA.setForeground(Color.BLACK);
		lblYourNumbersB.setForeground(Color.BLACK);
		lblReceiptGameTitle2.setForeground(Color.BLACK);
		lblDashedLines1.setFont(new Font("Segoe UI", Font.BOLD, 16));
		lblDashedLines2.setFont(new Font("Segoe UI", Font.BOLD, 16));
		lblCorrectNumbersA.setForeground(Color.BLACK);
		lblCorrectNumbersB.setForeground(Color.BLACK);
	}

	private void visibleComponentsCategories() {
		lblPrizepool.setIcon(new ImageIcon("Images/prizepoolLotto.gif"));

		btnA1.setVisible(true);
		btnA2.setVisible(true);
		btnA3.setVisible(true);
		btnA4.setVisible(true);
		btnA5.setVisible(true);
		btnA6.setVisible(true);
		btnA7.setVisible(true);
		btnA8.setVisible(true);
		btnA9.setVisible(true);
		btnA10.setVisible(true);
		btnA11.setVisible(true);
		btnA12.setVisible(true);
		btnA13.setVisible(true);
		btnA14.setVisible(true);
		btnA15.setVisible(true);
		btnA16.setVisible(true);
		btnA17.setVisible(true);
		btnA18.setVisible(true);
		btnA19.setVisible(true);
		btnA20.setVisible(true);
		btnA21.setVisible(true);
		btnA22.setVisible(true);
		btnA23.setVisible(true);
		btnA24.setVisible(true);
		btnA25.setVisible(true);
		btnA26.setVisible(true);
		btnA27.setVisible(true);
		btnA28.setVisible(true);
		btnA29.setVisible(true);
		btnA30.setVisible(true);
		btnA31.setVisible(true);
		btnA32.setVisible(true);
		btnA33.setVisible(true);
		btnA34.setVisible(true);
		btnA35.setVisible(true);
		btnA36.setVisible(true);
		btnA37.setVisible(true);
		btnA38.setVisible(true);
		btnA39.setVisible(true);
		btnA40.setVisible(true);
		btnA41.setVisible(true);
		btnA42.setVisible(true);

		btnB1.setVisible(true);
		btnB2.setVisible(true);
		btnB3.setVisible(true);
		btnB4.setVisible(true);
		btnB5.setVisible(true);
		btnB6.setVisible(true);
		btnB7.setVisible(true);
		btnB8.setVisible(true);
		btnB9.setVisible(true);
		btnB10.setVisible(true);
		btnB11.setVisible(true);
		btnB12.setVisible(true);
		btnB13.setVisible(true);
		btnB14.setVisible(true);
		btnB15.setVisible(true);
		btnB16.setVisible(true);
		btnB17.setVisible(true);
		btnB18.setVisible(true);
		btnB19.setVisible(true);
		btnB20.setVisible(true);
		btnB21.setVisible(true);
		btnB22.setVisible(true);
		btnB23.setVisible(true);
		btnB24.setVisible(true);
		btnB25.setVisible(true);
		btnB26.setVisible(true);
		btnB27.setVisible(true);
		btnB28.setVisible(true);
		btnB29.setVisible(true);
		btnB30.setVisible(true);
		btnB31.setVisible(true);
		btnB32.setVisible(true);
		btnB33.setVisible(true);
		btnB34.setVisible(true);
		btnB35.setVisible(true);
		btnB36.setVisible(true);
		btnB37.setVisible(true);
		btnB38.setVisible(true);
		btnB39.setVisible(true);
		btnB40.setVisible(true);
		btnB41.setVisible(true);
		btnB42.setVisible(true);

		if(iscbUltraLottoclicked) {
			lblPrizepool.setIcon(new ImageIcon("Images/prizepoolUltraLotto.gif"));
			btnA43.setVisible(true);
			btnA44.setVisible(true);
			btnA45.setVisible(true);
			btnA46.setVisible(true);
			btnA47.setVisible(true);
			btnA48.setVisible(true);
			btnA49.setVisible(true);
			btnA50.setVisible(true);
			btnA51.setVisible(true);
			btnA52.setVisible(true);
			btnA53.setVisible(true);
			btnA54.setVisible(true);
			btnA55.setVisible(true);
			btnA56.setVisible(true);
			btnA57.setVisible(true);
			btnA58.setVisible(true);

			btnB43.setVisible(true);
			btnB44.setVisible(true);
			btnB45.setVisible(true);
			btnB46.setVisible(true);
			btnB47.setVisible(true);
			btnB48.setVisible(true);
			btnB49.setVisible(true);
			btnB50.setVisible(true);
			btnB51.setVisible(true);
			btnB52.setVisible(true);
			btnB53.setVisible(true);
			btnB54.setVisible(true);
			btnB55.setVisible(true);
			btnB56.setVisible(true);
			btnB57.setVisible(true);
			btnB58.setVisible(true);
		}
		else if (iscbGrandLottoclicked) {
	...
	private void btnNumbersSetForeground() {
		...
		btnA15.setForeground(Color.BLACK);
		btnA16.setForeground(Color.BLACK);
		btnA17.setForeground(Color.BLACK);
		btnA18.setForeground(Color.BLACK);
		btnA19.setForeground(Color.BLACK);
		btnA20.setForeground(Color.BLACK);
		btnA21.setForeground(Color.BLACK);
		btnA22.setForeground(Color.BLACK);
		btnA23.setForeground(Color.BLACK);
		btnA24.setForeground(Color.BLACK);
		btnA25.setForeground(Color.BLACK);
		btnA26.setForeground(Color.BLACK);
		btnA27.setForeground(Color.BLACK);
		btnA28.setForeground(Color.BLACK);
		btnA29.setForeground(Color.BLACK);
		btnA30.setForeground(Color.BLACK);
		btnA31.setForeground(Color.BLACK);
		btnA32.setForeground(Color.BLACK);
		btnA33.setForeground(Color.BLACK);
		btnA34.setForeground(Color.BLACK);
		btnA35.setForeground(Color.BLACK);
		btnA36.setForeground(Color.BLACK);
		btnA37.setForeground(Color.BLACK);
		btnA38.setForeground(Color.BLACK);
		btnA39.setForeground(Color.BLACK);
		btnA40.setForeground(Color.BLACK);
		btnA41.setForeground(Color.BLACK);
		btnA42.setForeground(Color.BLACK);
		btnA43.setForeground(Color.BLACK);
		btnA44.setForeground(Color.BLACK);
		btnA45.setForeground(Color.BLACK);
		btnA46.setForeground(Color.BLACK);
		btnA47.setForeground(Color.BLACK);
		btnA48.setForeground(Color.BLACK);
		btnA49.setForeground(Color.BLACK);
		btnA50.setForeground(Color.BLACK);
		btnA51.setForeground(Color.BLACK);
		btnA52.setForeground(Color.BLACK);
		btnA53.setForeground(Color.BLACK);
		btnA54.setForeground(Color.BLACK);
		btnA55.setForeground(Color.BLACK);
		btnA56.setForeground(Color.BLACK);
		btnA57.setForeground(Color.BLACK);
		btnA58.setForeground(Color.BLACK);
		...
		btnB15.setForeground(Color.BLACK);
		btnB16.setForeground(Color.BLACK);
		btnB17.setForeground(Color.BLACK);
		btnB18.setForeground(Color.BLACK);
		btnB19.setForeground(Color.BLACK);
		btnB20.setForeground(Color.BLACK);
		btnB21.setForeground(Color.BLACK);
		btnB22.setForeground(Color.BLACK);
		btnB23.setForeground(Color.BLACK);
		btnB24.setForeground(Color.BLACK);
		btnB25.setForeground(Color.BLACK);
		btnB26.setForeground(Color.BLACK);
		btnB27.setForeground(Color.BLACK);
		btnB28.setForeground(Color.BLACK);
		btnB29.setForeground(Color.BLACK);
		btnB30.setForeground(Color.BLACK);
		btnB31.setForeground(Color.BLACK);
		btnB32.setForeground(Color.BLACK);
		btnB33.setForeground(Color.BLACK);
		btnB34.setForeground(Color.BLACK);
		btnB35.setForeground(Color.BLACK);
		btnB36.setForeground(Color.BLACK);
		btnB37.setForeground(Color.BLACK);
		btnB38.setForeground(Color.BLACK);
		btnB39.setForeground(Color.BLACK);
		btnB40.setForeground(Color.BLACK);
		btnB41.setForeground(Color.BLACK);
		btnB42.setForeground(Color.BLACK);
		btnB43.setForeground(Color.BLACK);
		btnB44.setForeground(Color.BLACK);
		btnB45.setForeground(Color.BLACK);
		btnB46.setForeground(Color.BLACK);
		btnB47.setForeground(Color.BLACK);
		btnB48.setForeground(Color.BLACK);
		btnB49.setForeground(Color.BLACK);
		btnB50.setForeground(Color.BLACK);
		btnB51.setForeground(Color.BLACK);
		btnB52.setForeground(Color.BLACK);
		btnB53.setForeground(Color.BLACK);
		btnB54.setForeground(Color.BLACK);
		btnB55.setForeground(Color.BLACK);
		btnB56.setForeground(Color.BLACK);
		btnB57.setForeground(Color.BLACK);
		btnB58.setForeground(Color.BLACK);
	...
	private void setVisibleReceipt() {
		lblUserChosenNumbers.setVisible(true);
		lblReceiptGameTitle.setVisible(true);
		lblReceiptGameTitle2.setVisible(true);
		lblReceiptA.setVisible(true);
		lblReceiptAgent.setVisible(true);
		lblReceiptAgentOutput.setVisible(true);
		lblReceiptB.setVisible(true);
		lblReceiptDate.setVisible(true);
		lblReceiptDateOutput.setVisible(true);
		lblReceiptDraw.setVisible(true);
		lblReceiptDrawOutput.setVisible(true);
		lblReceiptLotto.setVisible(true);
		lblDashedLines1.setVisible(true);
		lblDashedLines2.setVisible(true);
	}
	...
	private void cbCategoriesVisible() {
		...
		lblChooseA.setVisible(true);
		lblChooseB.setVisible(true);
		lblGameField.setVisible(true);
		lblPrizepool.setVisible(true);
		lblPrizepool.setVisible(true);
